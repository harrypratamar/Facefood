	  ...
	  <div class="row">
	    ...
	    <div style="opacity: 0.9">
	    	...
	    	<div style="padding:1rem">
		    	<div class="card">
		    		<div class="card-body">
				    	<a class="btn btn-outline-info float-md-right" href="menu_drink.php">Pesan Minuman Lain</a>
				    	<h3>Pesan Minuman</h3>
				    	<?php
						$no=$_GET['no'];
						$query=mysql_query("select * from drink where no='$no'");
						?>
					    <form method="post" action="order_drink_process.php?no=<?php echo $no; ?>">
					    <?php
						...
						?>
							...
							<div class="form-group">
							    ...
							    <td><input name="nama" type="text" class="form-control" required="" readonly value="<?php echo $row['nama']; ?>"></div></td>
							<div class="form-group">
							    <label for="harga">Harga</label>
							    <input name="harga" type="text" class="form-control" required="" readonly value="<?php echo $row['harga']; ?>"></div>
							<div class="form-group">  
					    	...
					    	<button class="btn btn-outline-info" type="submit">&nbsp;&nbsp;&nbsp;&nbsp;Tambah Ke Daftar Pesanan&nbsp;&nbsp;&nbsp;&nbsp;</button>
					    	<?php
								}
							  ?>
					    </form>
