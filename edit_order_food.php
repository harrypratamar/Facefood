...
<head>
	<meta charset="utf-8">
	<title>Edit Pesanan Makanan</title>
	    	...
	    	<div style="padding:1rem">
		    	<div class="card">
		    		<div class="card-body">
				    	...
				    	<?php
						$nama=$_GET['nama'];
						$query=mysql_query("select * from orderfood where nama='$nama'");
						?>
					    <form method="post" action="edit_order_food_process.php">
					    <?php
						...
						?>
					    	...
					    	<a class="btn btn-outline-danger" href="delete_order_food.php?nama=<?=$row['nama']?>">hapus</a>
					    	<?php
								}
							  ?>
					    </form>
