...
<head>
	<meta charset="utf-8">
	<title>Edit Pesanan Dessert</title>
	  ...
	  <div class="row">
	    ...
	    <div class="col-md-4">
	    	<div style="padding:1rem">
		    	<div class="card">
		    		<div class="card-body">
				    	<h3>Edit Pesanan Dessert</h3>
				    	<?php
						$nama=$_GET['nama'];
						$query=mysql_query("select * from orderdessert where nama='$nama'");
						?>
					    <form method="post" action="edit_order_dessert_process.php">
					    <?php
						...
						?>
					    	...
					    	<a class="btn btn-outline-danger" href="delete_order_dessert.php?nama=<?=$row['nama']?>">Hapus Pesanan</a>
					    	<?php
								}
							  ?>
					    </form>
