...
<body>
	<div class="container-fluid">
	    ...
	    <div style="opacity: 0.8">
			...
			<div class="card-body">
				<a class="btn btn-outline-danger my-2 my-sm-0" href="add_admin.php">Tambah Admin</a>
				<div style="text-align: center">
					<img src="assets/image/icon_title.png" width="220" height="220"> </div>	
				  <div class="text-center">
					    <h4 class="card-title text-success">Admin</h4>
					    <p class="card-text">Simpan Username dan Password dengan Baik, Jangan Berikan Akun Admin Ke Sembarang Orang</p>
				  	</div><br>
