              ...
              <div class="row products products-big">
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    ...
                    <?php
                    $query = "SELECT * FROM dessert where no='1'";
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='2'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='3'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='4'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='5'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                 <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='6'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='7'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='8'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='9'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='10'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='11'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                 <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='12'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                 <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='13'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='14'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='15'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='16'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='17'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><alt="" class="img-fluid image1">
                    <?php
                    $query = "SELECT * FROM dessert where no='18'";
                    $result = mysql_query($query);
                    $i=1;
                    while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {  
                      echo "<td><img src='admin/images/".$row['foto']."' width='250' height='200'></td>" ?> <alt="" class="img-fluid image1"></a></div>
