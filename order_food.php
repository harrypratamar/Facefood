	  ...
	  <div class="row">
	    ...
	    <div style="opacity: 0.9">
	    	...
	    	<div style="padding:1rem">
		    	<div class="card">
		    		<div class="card-body">
				    	<a class="btn btn-outline-success float-md-right" href="menu_food.php">Pesan Makanan Lain</a>
				    	<h3>Pesan Makanan</h3>
				    	<?php
						$no=$_GET['no'];
						$query=mysql_query("select * from food where no='$no'");
						?>
					    <form name="food" method="post" action="order_food_process.php?no=<?php echo $no; ?>">
					    <?php
						...
						?>
							...
							<div class="form-group">
							    ...
							    <input name="nama" type="text" class="form-control" readonly value="<?php echo $row['nama']; ?>"></div>
							<div class="form-group">
							    <label for="harga">Harga</label>
							    <input name="harga" type="text" class="form-control" readonly value="<?php echo $row['harga']; ?>"></div>
                      		<div class="form-group">  
					    	...
					    	<button class="btn btn-outline-success" type="submit">&nbsp;&nbsp;&nbsp;&nbsp;Tambah Ke Daftar Pesanan&nbsp;&nbsp;&nbsp;&nbsp;</button>
					    	<?php
								}
							  ?>
					    </form>
